...
void forward_fast()
{
  ...
  while(code60<2200)
  {
    ...
    else if((digitalRead(SW2)==0)&&(digitalRead(SW0)==1))
    {
        delay(1);
        if((digitalRead(SW2)==0)&&(digitalRead(SW0)==1)&&(code60>200))
        {
          break;
        }
    }
    else if((digitalRead(SW4)==0)&&(digitalRead(SW5)==1))
    {
        delay(1);
        if((digitalRead(SW4)==0)&&(digitalRead(SW5)==1)&&(code60>200))
        {
          break;
        }
    }
